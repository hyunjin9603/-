...
ca = certifi.where()
client = MongoClient('mongodb+srv://test:sparta@cluster0.fopdzyo.mongodb.net/Cluster0?retryWrites=true&w=majority',
                     tlsCAFile=ca)
db = client.dbsparta
...
def get_posts():
    ...
    try:
        ...
        for word in words:
            ...
            word["bookmark_by_me"] = bool(db.likes.find_one({'_id': word["_id"], "username": payload['id']}))
...
def update_like():
    ...
    try:
        ...
        return jsonify({"result": "success", 'msg': 'updated', 'username':user_id})
